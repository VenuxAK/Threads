...
<template>
  <div
    class="flex w-full flex-row items-center gap-2 rounded-[99px] border border-gray-900/10 bg-gray-900/5 dark:border-darkGray dark:bg-dark p-2"
  >
    <div class="flex">
      <button
        class="relative h-6 max-h-[24px] w-6 max-w-[24px] select-none rounded-full text-center align-middle font-sans text-xs font-medium uppercase text-gray-900 transition-all hover:bg-gray-900/10 active:bg-gray-900/20 disabled:pointer-events-none disabled:opacity-50 disabled:shadow-none"
        type="button"
      >
        <span
...
.comment-form {
  @apply bg-transparent border dark:border-darkGray px-5 py-3 rounded-md w-full focus:outline-none focus:ring-1 mb-3;
}
</style>
